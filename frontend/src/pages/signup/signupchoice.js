  ...
  return (
    ...
    <div className="signup-page">
      ...
      <div className="signup-card-list">
        <button className="signup-card kakao" onClick={() => window.location.href = "https://readforce-app-backend-production.up.railway.app/oauth2/authorization/kakao"}>
        ...
        <button className="signup-card google" onClick={() => window.location.href = "https://readforce-app-backend-production.up.railway.app/oauth2/authorization/google"}>
